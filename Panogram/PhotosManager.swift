...
class PhotosManager {
    ...
    func cacheImages() throws {
        ...
        cachingImageManager.startCachingImages(for: pAssets, targetSize: CGSize(width: 600, height: 200), contentMode: .default, options: nil)
        
    }
    
    func fetchImage(at i: Int, cached: Bool, completion:@escaping (Int, UIImage) -> Void) {
